...
- Learn how to use different strategy sets in the [Quick Start](/mdx/quickstart) guide
- Explore the [API Reference](/mdx/api-reference/gethtml) for detailed information on the `getHtml` function
- Discover how to create [Custom Strategies](/mdx/advanced/custom-strategies) for advanced use cases