...
You can customize the waterfall approach by creating your own strategy sets. This allows you to tailor the fetching process to your specific needs. Learn more in the [Custom Strategies](/mdx/advanced/custom-strategies) section.

## Next Steps

- Explore different [Fetching Strategies](/mdx/concepts/strategies) used in Waterfall-Fetch
- Learn how to use strategy sets in the [Quick Start](/mdx/quickstart) guide
- Dive into [Custom Strategies](/mdx/advanced/custom-strategies) for advanced usage