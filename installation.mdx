...
Now that you have Waterfall-Fetch installed, you're ready to start using it in your project. Check out the [Quick Start](/quickstart) guide for basic usage examples, or dive into the [API Reference](/api-reference/gethtml) for more detailed information.